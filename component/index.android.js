...
NotificationsComponent.prototype.setApplicationIconBadgeNumber = function(number: int) {
	RNPushNotification.setApplicationIconBadgeNumber(number);
};

NotificationsComponent.prototype.getApplicationIconBadgeNumber = function(callback: Function) {
